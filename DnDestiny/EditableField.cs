...
namespace DnDestiny
{
    class EditableField
    {
        ...
        public EditableField(Vector2 factor, SpriteFont font, Rectangle startPosition, string startingValue)
        {
            this.factor = factor;
            this.font = font;
        ...
        public void CalcInput(MouseState ms, MouseState pms, KeyboardState kb, KeyboardState pkb)
        {
            if (Position(ms).Contains(ms.Position))
            {
